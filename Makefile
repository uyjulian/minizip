...
CFLAGS += -O2 -flto
CFLAGS += -Wall -Wno-unused-value -Wno-format -fpermissive -I. -I.. -I../ncbind -Iexternal/zlib -Iexternal/minizip -Iexternal/minizip/lib/bzip2  -Iexternal/minizip/lib/liblzma -Iexternal/minizip/lib/liblzma/api -Iexternal/minizip/lib/liblzma/check -Iexternal/minizip/lib/liblzma/common -Iexternal/minizip/lib/liblzma/lz -Iexternal/minizip/lib/liblzma/lzma -Iexternal/minizip/lib/liblzma/rangecoder  -DGIT_TAG=L\"$(GIT_TAG)\" -DNDEBUG -DWIN32 -D_WIN32 -D_WINDOWS 
